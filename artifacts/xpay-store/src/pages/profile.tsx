      ...
      <div className="bg-card/50 border-b border-white/5 pt-12 pb-8 px-4 text-center rounded-b-[2rem] shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground mb-4">
            <span className="bg-white/5 px-3 py-1 rounded-full border border-white/5 font-mono">ID: {shortId}</span>
            <span className="bg-white/5 px-3 py-1 rounded-full border border-white/5 font-mono">TG: {profile?.telegramId}</span>
            {profile?.role === "admin" && (
