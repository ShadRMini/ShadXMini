...
export async function ensureDatabaseSchema() {
  ...
  try {
    ...
    const maintenanceDefaultKeys = [
      ...
      // Multi-Theme System Defaults
      { key: "theme_mode", val: "dark" },
      { key: "theme_active_preset", val: "gold" },
      { key: "theme_primary", val: "#C8A45C" },
      { key: "theme_secondary", val: "#B8954A" },
      { key: "theme_accent", val: "#FDE68A" },
      { key: "theme_background", val: "#1A1A1A" },
      { key: "theme_card", val: "#2D2D2D" },
      { key: "theme_text_primary", val: "#FFFFFF" },
      { key: "theme_text_secondary", val: "#E5E7EB" },
      { key: "theme_text_muted", val: "#9CA3AF" },
      { key: "theme_border", val: "rgba(200, 164, 92, 0.25)" },
      { key: "theme_input_bg", val: "#3D3D3D" },
      { key: "theme_header_gradient_start", val: "#1A1A1A" },
      { key: "theme_header_gradient_end", val: "#2D2D2D" },
      { key: "theme_bottom_nav", val: "#1A1A1A" },
      { key: "theme_bottom_nav_active", val: "#C8A45C" },
      { key: "theme_sidebar_bg", val: "#1A1A1A" },
      { key: "theme_font_arabic", val: "Cairo" },
      { key: "theme_font_english", val: "Inter" },
      { key: "theme_font_size", val: "14" },
      { key: "theme_heading_size", val: "20" },
      { key: "theme_border_radius", val: "16" },
      { key: "theme_shadow", val: "medium" },
      { key: "theme_padding", val: "24" },
      { key: "theme_logo_size", val: "80px" },
      { key: "balance_gradient_start", val: "#1E40AF" },
      { key: "balance_gradient_mid", val: "#3B82F6" },
      { key: "balance_gradient_end", val: "#60A5FA" },
      { key: "balance_text_color", val: "#FFFFFF" },
      { key: "balance_subtext_color", val: "#E0F2FE" },
      { key: "balance_badge_color", val: "#FFFFFF" },
      { key: "balance_currency_color", val: "#FFFFFF" },
      { key: "balance_radius", val: "24" },
      { key: "balance_padding", val: "24" },
      { key: "balance_amount_size", val: "32" },
      { key: "balance_label_size", val: "14" },
      { key: "balance_shadow", val: "heavy" },
      { key: "balance_glow_enabled", val: "true" },
      { key: "balance_glow_color", val: "#3B82F6" },
      {
