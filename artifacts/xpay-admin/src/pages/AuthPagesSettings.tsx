  ...
  const fetchConfig = async () => {
    ...
    try {
      ...
      try {
        ...
        if (themeRes) {
          setAuthTheme({
            bg_color: themeRes.auth_bg_color || "",
            card_color: themeRes.auth_card_color || "",
            text_color: themeRes.auth_text_color || "",
            title_color: themeRes.auth_title_color || "",
            border_color: themeRes.auth_border_color || "",
            button_color: themeRes.auth_button_color || "",
            button_text_color: themeRes.auth_button_text_color || "",
            button_hover_color: themeRes.auth_button_hover_color || "",
