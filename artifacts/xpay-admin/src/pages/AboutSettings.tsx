  ...
  const fetchConfig = async () => {
    ...
    try {
      ...
      try {
        ...
        if (themeRes) {
          setAboutTheme({
            bg_color: themeRes.about_bg_color || "",
            card_color: themeRes.about_card_color || "",
            text_color: themeRes.about_text_color || "",
            title_color: themeRes.about_title_color || "",
            border_color: themeRes.about_border_color || "",
            button_color: themeRes.about_button_color || "",
            button_text_color: themeRes.about_button_text_color || "",
            button_hover_color: themeRes.about_button_hover_color || "",
