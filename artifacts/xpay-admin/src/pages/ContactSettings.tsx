  ...
  useEffect(() => {
    ...
    get<any>("/admin/theme-settings")
      .then((themeRes) => {
        if (themeRes && active) {
          setContactTheme({
            bg_color: themeRes.contact_bg_color || "",
            card_color: themeRes.contact_card_color || "",
            text_color: themeRes.contact_text_color || "",
            title_color: themeRes.contact_title_color || "",
            border_color: themeRes.contact_border_color || "",
            button_color: themeRes.contact_button_color || "",
            button_text_color: themeRes.contact_button_text_color || "",
            button_hover_color: themeRes.contact_button_hover_color || "",
