  ...
  const fetchSettings = async () => {
    ...
    try {
      ...
      try {
        ...
        if (themeRes) {
          setProductTheme({
            bg_color: themeRes.product_bg_color || "",
            card_color: themeRes.product_card_color || "",
            text_color: themeRes.product_text_color || "",
            title_color: themeRes.product_title_color || "",
            border_color: themeRes.product_border_color || "",
            button_color: themeRes.product_button_color || "",
            button_text_color: themeRes.product_button_text_color || "",
            button_hover_color: themeRes.product_button_hover_color || "",
